"""
Trains a ResNet-50 classifier for 5-class DR severity grading (0-4).
...
ResNet-50 with class-weighted cross-entropy loss, and evaluates each epoch
...
# ---------------- CONFIG ----------------
TRAIN_MANIFEST_PATH = r"D:\Thesis Dataset\final dataset\splits\train_manifest.csv"
VAL_MANIFEST_PATH = r"D:\Thesis Dataset\final dataset\splits\val_manifest.csv"
IMAGE_FOLDER = r"D:\Thesis Dataset\final dataset\images"
IMAGE_EXT = ".png"

CHECKPOINT_DIR = r"D:\Thesis Dataset\final dataset\checkpoints\resnet50"

IMAGE_COL = "image"
LABEL_COL = "level"
NUM_CLASSES = 5

INPUT_SIZE = 224          # ResNet-50 standard input resolution
BATCH_SIZE = 32
NUM_EPOCHS = 30
LEARNING_RATE = 1e-4
WEIGHT_DECAY = 1e-4
